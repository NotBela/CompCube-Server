...
namespace LoungeSaber_Server.Api.BeatSaver;

public class BeatSaverApiWrapper
{
    private readonly BeatSaverSharp.BeatSaver _beatSaver = new(new BeatSaverOptions("LoungeSaber-Server", new Version("1.0.0")));
